      ...
      <div class="container-fluid">
            ...
            <div class="col-12 col-sm-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center bg-secondary">
                        ...
                        <h4 class="m-0">Edit Configuration Status Data</h4>
                    </div>
                    <div class="card-body">
                        <div>
                            ...
                            <form method="post" name="dataTableForm" id="dataTableForm" action="">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="name" id="name" placeholder="Name" class="form-control" value="{{$configuration_status->name}}"></input>
                                    <p></p>
                                </div>
        ...
        <script type="text/javascript">
            $("#dataTableForm").submit(function(event){
                ...
                $.ajax({
                    url: "{{ route('pages.management.configuration-statuses.update', $configuration_status->id) }}",
