                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <form action="{{ route('dynamic-table.store') }}" method="POST">
                                @csrf
                                @method('POST')
                                {{-- Item Column --}}
                                ...
                                @foreach ($serial_number_column as $column)
                                    <div>
                                        <label for="{{ $column }}">{{ $column }}</label>
                                        <input type="text" name="{{ $column }}" id="{{ $column }}" placeholder="{{ $column }}" class="form-control"></input>
                                        <p></p>
                                    </div>
                                @endforeach
                                ...
                                <div>
                                    <div class="form-group">
                                        <label for="{{ $column }}">{{ $column }}</label>
                                        <input type="text" name="{{ $column }}" id="{{ $column }}" placeholder="{{ $column }}" class="form-control">
                                    </div>
                                </div>
                                @endforeach --}}
                                <div>
